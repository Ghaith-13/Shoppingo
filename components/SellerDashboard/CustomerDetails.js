...
function CustomerDetails(props) {
  ...
  return (
    <Popup
      trigger={
        <button
          ...
          }  py-3 md:mx-2 my-2 md:my-0 dark:bg-gradient-to-tr  dark:from-darkBgColor dark:to-darkTextColor2 dark:hover:bg-gradient-to-tl`}
        >
          {' '}
    ...
    >
      {(close) => (
        <>
          <div className="fixed z-10 top-[50%] left-[50%] translate-y-[-50%] translate-x-[-50%] flex flex-col justify-between shadow-2xl rounded-lg bg-gray-50 dark:bg-gradient-to-tr dark:from-darkBgColor dark:to-darkTextColor2 w-[250px] md:w-[650px] h-[450px] md:h-[350px] p-3 md:p-10">
